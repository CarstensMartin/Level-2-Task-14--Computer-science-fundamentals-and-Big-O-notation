...
public class BigO {
	...
	public static void main(String[] args) {
		...
		list.add(searchElimentPlacementPosition(list, numberToAdd), numberToAdd);
	...
	public static void addEliment(List<Integer> list, int number) {
	...
	public static int searchElimentPlacementPosition(List<Integer> list, int number) {
